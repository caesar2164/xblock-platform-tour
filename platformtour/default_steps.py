...
DEFAULT_STEPS = [
    {
        ...
        'intro': "Welcome to the platform walkthrough tour! Let's start by exploring the tabs at the top of the page.",
        'position': 'right',
    },
    {
        'key': 'course_tab',
    ...
    },
    {
        ...
        'intro': 'Notice the trail of breadcrumb links above the content. You are currently on a page, or unit...',
        'position': 'below',
    },
    {
    ...
    },
    {
        ...
        'intro': "...in a module, or section. Clicking on a breadcrumb will take you to your course's table of contents, and drop you onto the portion related to the section or subsection you clicked on.",
        'position': 'right',
    },
    {
        ...
        'intro': "This 'Course' link will also take you to the table of contents, but to the beginning, as opposed to a specific section or subsection.",
        'position': 'right',
    },
    {
        'key': 'filmstrip',
        ...
        'intro': 'Every lesson or subsection is structured as a sequence of pages, or units. Each button on this navigator corresponds to a page of content. You should go through the pages from left to right.',
        'position': 'left',
    },
    {
    ...
    },
    {
        ...
        'intro': 'If you want to get back later to the content on a particular page, or you want to save it as something important, bookmark it. A Bookmarks folder on your course home page will contain a link to any page you bookmark for easy access later.',
        'position': 'right',
    },
    {
        'key': 'course_progress',
    ...
    },
    {
        ...
        'intro': 'For course-specific questions, click on the \'Discussion\' tab to post your question to the forum. Peers and course teams may be able to answer your question there.',
        'position': 'left',
    },
    {
        'key': 'help_link',
        'title': 'Help Link',
        'element': 'a.doc-link',
        'intro': 'For any technical issues or platform-specific questions, click on the \'Help\' link to access the Help Center or contact support.',
        'position': 'bottom',
    },
    {
        'key': 'tour_done',
